...
require("prototypes.resources.polymer-resin")
require("prototypes.resources.fuel")
require("prototypes.resources.turbofuel")
require("prototypes.resources.compacted-coal")
require("prototypes.resources.petroleum-coke")
require("prototypes.resources.alumina-solution")
require("prototypes.resources.battery")
