local vanillatechs = {
	...
	"turrets", "laser-turrets", "artillery",
	"automobilism", "tanks", "spidertron",
	...
	"combat-robotics", "combat-robotics-2", "combat-robotics-3",
	...
	-- "gun-turret", "laser-turret", "defender", "distractor", "destroyer", "tank", "stone-wall", "gate"
}
