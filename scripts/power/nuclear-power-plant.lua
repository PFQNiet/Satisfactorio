...
local base = "nuclear-power-plant"
local boiler = base.."-boiler"
local boiler_pos = {0,9.5}
local generator_ne = base.."-generator-ne"
local generator_sw = base.."-generator-sw"
local generator = {
...
local generator_pos = {0,-1}
local accumulator = base.."-accumulator"
